            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="supplier_id" class="form-control">
                        ...
                        <option value="{{ $supplier->id }}" @if ($product->supplier_id == $supplier->id || old('supplier_id') == $supplier->id)
                            selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="py-2">
                                <textarea name="description[{{ $locale }}]" rows="6"
                                    class="form-control">{!! @old('description')[$locale] ?? $product->getTranslation('description', $locale) !!}</textarea>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <div class="form-group">
                            ...
                            <input name="stock[]" type="number" class="form-control" value="{{ $variation->stock }}">
                        </div>
                        <div class="form-group">
                            <label>{{ __('Photo') }}</label>
                            <div class="custom-file">
                                <input type="file" name="photo[]" class="custom-file" id="photo{{ $variation->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input name="sale_price[]" type="number" class="form-control"
                                        placeholder="{{ __('Sale Price') }}" value="{{ $variation->sale_price }}">
                                </div>
                            </div>
                        </div>
                    </div>
